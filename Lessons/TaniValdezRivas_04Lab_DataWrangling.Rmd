...
summary(NTL.phys.data$lakename) # can use levels(NTL.phys.data$lakename)
...
NTL.phys.data.Tuesay.1990.1999 <- filter(NTL.phys.data, lakename == "Tuesday Lake", year4 >= 1990, year4 <= 1999)
```
...
NTL.phys.data.Tuesay.1990.1999.July <-
  NTL.phys.data %>%
