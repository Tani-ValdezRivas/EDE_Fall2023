...
Ozone_plot_1 <- ggplot(EPAair, aes(x=Ozone, fill=as.factor(Year)))+
...
Ozone_plot_2 <- ggplot(EPAair, aes(x=as.factor(Year), y=Ozone)) +
  geom_boxplot()+
...
Ozone_plot_3 <- ggplot(EPAair, aes(x=as.factor(Year), y=Ozone)) +
