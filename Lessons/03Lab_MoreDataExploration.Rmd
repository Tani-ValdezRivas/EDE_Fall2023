...
HighTemps <- c(81, 83, 83, 84, 78, 71, 79, 82, 85, 84)
HighTemps
LowTemps <- c(55, 56, 58, 60, 61, 63, 63, 64, 64, 63)
LowTemps
...
Conversion_to_High_C <- function(x){
    x <- (HighTemps-32) * 5/9
}
  HighTemps_in_C <- Conversion_to_High_C(HighTemps)
  HighTemps_in_C

Conversion_to_Low_C <- function(x){
    x <- (LowTemps-32) * 5/9
}
  LowTemps_in_C <- Conversion_to_Low_C(LowTemps)
  LowTemps_in_C
 
  
# or another way to do this

high_c <- (HighTemps - 32) * 5/9
high_c

low_c <- (LowTemps - 32) * 5/9
low_c
...
df_temp <- cbind(HighTemps, LowTemps, HighTemps_in_C, LowTemps_in_C)
df_temp
